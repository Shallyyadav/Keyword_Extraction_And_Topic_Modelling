...
In the twenty-first century, AI techniques have experienced a resurgence following concurrent advances in computer power, large amounts of data, and theoretical understanding; and AI techniques have become an essential part of the technology industry, helping to solve many challenging problems in computer science, software engineering and operations research.`;
    ...
    function loadAnalysisById(analysisId) {
        showError('Analysis history is not available in this version.');
    }
    ...
    function updateTextStats(stats) {
        ...
        avgWordLength.textContent = stats.avg_word_length;
    }
    ...
    function exportResults() {
        ...
        exportContent += `- Average Word Length: ${stats.avgWordLength}\n\n`;
